...
export default function EditPageForm({ params }: { params: { id: string } }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Update the page
      await apiClient.update("page", id, processedData)
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Edit Page: {formData.title}</h1>
